...
def main(args, log):
    ...
    for fold_idx, (train_idx, test_idx) in enumerate(skf.split(cluster_abundances, labels)):
        fold = f"fold_{fold_idx + 1}"
        abundances_train, abundances_test = cluster_abundances[train_idx], cluster_abundances[test_idx]
